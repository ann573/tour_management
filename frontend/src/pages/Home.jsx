        ...
        <Col lg='6'>
          <div className='hero_content'>
            <div className="hero_subtitle d-flex align-items-center">
              ...
              <h1>Du lịch là một cách để tạo cho chúng ta{""} 
                <span className="highlight">{""} KỶ NIỆM</span>
              </h1>
              <p>Chúng tôi tự hào mang đến cho các bạn một trải nghiệm du lịch một cách tuyệt vời nhất.</p>
          </div>
        </Col>
        <Col lg='2'>
        ...
        <Row>
          <Col lg='6'>
            <div className="experience_content">
              ...
              <p>Tự hào là nơi tổ chức những tour du lịch hàng đầu Việt Nam. 
                <br />
                 Với nhiều năm kinh nghiệm trong ngành du lịch Việt, cùng với đó là có lượng khách hàng thân thiết vô cùng lớn.</p>            
            </div>
