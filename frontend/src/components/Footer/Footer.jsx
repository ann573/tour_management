      ...
      <Container>
        <Row>
          <Col lg='3'>
            <div className="logo">
              <img src={logo} alt="" />
              <p>Chào mừng bạn đến với Vintour - nơi bạn khám phá thế giới một cách đầy đam mê và chuyên nghiệp. 
                Với tinh thần mở cửa cảm xúc, chúng tôi cam kết mang đến cho bạn những trải nghiệm du lịch độc đáo và không quên. 
                Hãy cùng chúng tôi khám phá những chuyến hành trình tuyệt vời và đắm chìm trong những kỷ niệm đáng nhớ trên khắp Việt Nam.</p>
